...
public class AdminController {
    ...
    */
    ...
    public JSONObject registry(@RequestBody JSONObject body, @RequestHeader("XXL-JOB-ACCESS-TOKEN") @Nullable String token) {
        ...
        info.put("admin",mainProperties.getServerPath() + action);
        ...
        try{
            ...
            String string = restTemplate.postForObject(mainProperties.getServerPath() + action,requestHttpEntity,String.class);
    ...
    * */
    ...
    private JSONObject reCall( String action , JSON body, String token) throws ParseException {
        ...
        try{
            ...
            result = restTemplate.postForObject(mainProperties.getServerPath() + action,requestHttpEntity,JSONObject.class);
